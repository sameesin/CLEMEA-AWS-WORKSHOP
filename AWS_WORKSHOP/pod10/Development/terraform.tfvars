...
ftd_mgmt_ip = ["10.10.1.10","10.x.10.10"]
ftd_outside_ip = ["10.10.2.10","10.x.20.10"]
ftd_inside_ip = ["10.10.3.10","10.x.30.10"]
ftd_diag_ip = ["10.10.4.10","10.x.40.10"]
ftd_app_ip = ["10.10.5.10","10.x.50.10"]
...
inside_interface_sg = [
    {
        ...
        protocol = "TCP"
        to_port = 80
        cidr_blocks = ["10.10.5.0/24","10.10.50.0/24"]
...
fmc_mgmt_interface_sg = [
    ...
    },
    {
        ...
        protocol = "TCP"
        to_port = 8305
        cidr_blocks = ["10.10.1.0/24","10.10.10.0/24"]
...
app_lb_name = "APP-LB-Pod10"

app_lb_ip1 = "10.10.5.100"

app_lb_ip2 = "10.10.50.100"

elb_name = "External-LB-pod10"

ilb_name = "Internal-LB-pod10"
